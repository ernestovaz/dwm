...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, "#000000", "#555555" },
};
...
static const char *roficmd[] = { "rofi", "-show", "run", "-font", "DejaVu Sans Mono 9","-width","25","-theme", "android_notification", NULL };
static const char *termcmd[]  = { "urxvt", NULL };

static Key keys[] = {
/* modifier             key    function        argument */
{ MODKEY,               33,    spawn,          {.v = roficmd } }, // p
...
{ MODKEY,               27,    setlayout,      {.v = &layouts[4]} },
{ MODKEY|ShiftMask,     27,    setlayout,      {.v = &layouts[5]} },
